/*
 * Title:   Miracle | Responsive Multi-Purpose Wordpress Theme - jQuery plugins
...
(function($) {
    ...
    $.miracle_loading = function() {
        ...
        var loader = {
            ...
            generate: function() {
                var parentObj = 'body';
                if ($(parentObj).find(".miracle-ajax-loading").length < 1) {
                    loader.loading_item = $('<div class="miracle-ajax-loading"></div>').hide().appendTo(parentObj);
                } else {
                    loader.loading_item = $(parentObj).find(".miracle-ajax-loading");
                }
            }
        }
